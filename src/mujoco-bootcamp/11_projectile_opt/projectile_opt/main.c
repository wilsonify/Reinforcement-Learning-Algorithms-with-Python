...
//Change the xml file
char path[] = "../myproject/projectile_opt/";
char xmlfile[] = "ball.xml";
...
void init_controller(const mjModel* m, mjData* d)
{
  ...
  double Xin[3]={v,theta,time_of_flight};
  double Xout[2] = {0};
...
int main(int argc, const char** argv)
{
    ...
    double arr_view[] = {89.608063, -11.588379, 10, 2.5000000, 0.000000, 1.000000};
