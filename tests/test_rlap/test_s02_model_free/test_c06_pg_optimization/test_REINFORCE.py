...
from rlap.s02_model_free.c06_pg_optimization.REINFORCE import mlp, softmax_entropy, Buffer
...
def test_REINFORCE():
    ...
    for ep in range(num_epochs):
        ...
        # Optimize the policy
        sess.run(
            p_opt, feed_dict={obs_ph: obs_batch, act_ph: act_batch, ret_ph: ret_batch}
        )
